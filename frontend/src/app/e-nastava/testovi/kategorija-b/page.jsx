...
export default function KategorijaB() {
  ...
  return (
    <div className="flex flex-col gap-16">
      ...
      <div className="grid grid-cols-6 max-xl:grid-cols-5 max-[1200px]:grid-cols-4 max-lg:grid-cols-3 max-[570px]:grid-cols-2 max-[410px]:grid-cols-1  gap-y-10 ml-4 ">
        {buttons.map((description, index) => (
          <Link
            key={index}
            href={`/e-nastava/testovi/kategorija-b/${description
              .toLowerCase()
              .replace(" ", "-")}`}
          >
