...
export default function Category({ category, index }) {
  return (
    ...
    >
      <div className=" flex items-center justify-center w-[60px] h-[60px]  transition duration-400 ease-in-out border border-white-60  rounded-full hover:border-red-70   ">
        <p className="text-red-70 text-[26px] font-light">{category}</p>
      </div>
